...
export default {
    ...
    ADD_PROPERTY : gql`mutation ADD_PROPERTY($coordinates: String = "", $description: String = "", $name: String = "", $sub_type: property_subtype_enum = Basement, $type: property_type_enum = Apartments) {
